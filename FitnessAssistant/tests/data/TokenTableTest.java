...
class TokenTableTest {
    ...
    void testConvertLineToTokensSingleToken() {
        String line = "5:Awake";
        ArrayList<String> expectedTokens = new ArrayList<>(List.of("Awake"));
    ...
    void testConvertLineToTokensMultipleTokens() {
        ...
        ArrayList<String> expectedTokens = new ArrayList<>(List.of("Awake", "Kite"));
        assertEquals(expectedTokens, TokenTable.convertLineToTokens(line));
    }
    ...
    void testConvertLineToTokensNoNumber() {
        String line = "Awake";
        assertThrows(IllegalArgumentException.class, () -> TokenTable.convertLineToTokens(line));
    }
    ...
    void testConvertToLinesSingleToken() {
        ...
        tokenTable.tokens.add(new ArrayList<>(List.of("Hello")));
        ArrayList<String> expectedLines = new ArrayList<>(List.of("5:Hello "));
    ...
    void testConvertToLinesMultipleTokens() {
        TokenTable tokenTable = new TokenTable();
        tokenTable.tokens.add(new ArrayList<>(List.of("Hello", "World")));
        ArrayList<String> expectedLines = new ArrayList<>(List.of("5:Hello 5:World "));
        assertEquals(expectedLines, tokenTable.convertToLines());
    }
    ...
    void testConvertToLinesMultipleLines() {
        TokenTable tokenTable = new TokenTable();
        tokenTable.tokens.add(new ArrayList<>(List.of("Hello", "World")));
        tokenTable.tokens.add(new ArrayList<>(List.of("foo", "bar")));
        ArrayList<String> expectedLines = new ArrayList<>(List.of("5:Hello 5:World ", "3:foo 3:bar "));
        assertEquals(expectedLines, tokenTable.convertToLines());
    }
    ...
    void testConvertToLinesTokensWithSpaces() {
        TokenTable tokenTable = new TokenTable();
        tokenTable.tokens.add(new ArrayList<>(List.of("Hello World", "foo")));
        ArrayList<String> expectedLines = new ArrayList<>(List.of("11:Hello World 3:foo "));
        assertEquals(expectedLines, tokenTable.convertToLines());
    }
    ...
    void testConvertToLinesEmptyTokens() {
        TokenTable tokenTable = new TokenTable();
        tokenTable.tokens.add(new ArrayList<>(List.of("", "")));
        ArrayList<String> expectedLines = new ArrayList<>(List.of("0: 0: "));
        assertEquals(expectedLines, tokenTable.convertToLines());
    }
}