...
public final class CreateMeal extends Command {

    private final MealRepository meals;
    private final FoodRepository foods;

    public CreateMeal(CommunicationChannel io, MealRepository mealRepository,
    ...
    private Meal create(String name, String description, double servings,
        ...
        for (MealPart mealPart : mealParts) {
            ...
            protein += mealPart.amount() * food.fat();
        }
